export async function getInfos() {
  ...
  return [
    ...
    },
    {
      ...
      title:
        "Pesquisa da Meta: 19% dos adolescentes no Instagram viram conteúdo sensível",
      excerpt:
    ...
    },
    {
      ...
      title:
        "IA generativa: como empresas estão adotando ChatGPT e concorrentes",
      excerpt:
    ...
    // —— Política ——
    {
      ...
      title:
        "Reforma tributária: entenda o que muda para empresas e consumidores",
      excerpt:
    ...
    },
    {
      ...
      title:
        "Libertadores: grupos definidos; brasileiros evitam favoritos na fase inicial",
      excerpt:
    ...
    },
    {
      ...
      title:
        "Atletas brasileiros iniciam etapa final de preparação para Paris 2024",
      excerpt:
    ...
    // —— Mundo ——
    {
      ...
      title:
        "Quando você ler esse texto, a África terá se aproximado mais da separação",
      excerpt:
    ...
    },
    {
      ...
      title:
        "NASA adia missão tripulada para a Lua novamente: entenda os atrasos",
      excerpt: "Agência espacial explica motivos técnicos e novo cronograma.",
    ...
    },
    {
      ...
      title:
        "Após faltar ao Oscar e ser premiado, Sean Penn aparece em foto com Zelensky",
      excerpt: "Ator e diretor encontram-se em contexto de apoio à Ucrânia.",
    ...
    },
    {
      ...
      title:
        "Tecnologia no campo: drones e sensores ganham espaço na agricultura",
      excerpt:
    ...
    // —— Cultura (Viagem & Gastronomia / lifestyle) ——
    {
      ...
      title:
        "Quem é Vittoria Ceretti, namorada de DiCaprio que estava no Oscar",
      excerpt: "Modelo italiana acompanhou o ator na cerimônia e rouba a cena.",
    ...
    },
    {
      ...
      excerpt: "Descubra qual ativo combina melhor com seu tipo de pele.",
    ...
    },
    {
      ...
      excerpt: "De praias a serras: roteiros para todos os gostos e bolsos.",
